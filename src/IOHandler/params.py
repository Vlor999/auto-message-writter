...
tables = {
    ...
    "chat_recoverable_message_join": [
        (0, "chat_id", "INTEGER", 0, None, 1),
        (1, "message_id", "INTEGER", 0, None, 2),
        (2, "delete_date", "INTEGER", 0, None, 0),
        (3, "ck_sync_state", "INTEGER", 0, "0", 0),
    ],
    "scheduled_messages_pending_cloudkit_delete": [
        (0, "ROWID", "INTEGER", 0, None, 1),
        (1, "guid", "TEXT", 1, None, 0),
        (2, "recordID", "TEXT", 0, None, 0),
    ],
    "handle": [
        (0, "ROWID", "INTEGER", 0, None, 1),
        (1, "id", "TEXT", 1, None, 0),
    ...
    "unsynced_removed_recoverable_messages": [
        (0, "ROWID", "INTEGER", 0, None, 1),
        (1, "chat_guid", "TEXT", 1, None, 0),
        (2, "message_guid", "TEXT", 1, None, 0),
        (3, "part_index", "INTEGER", 0, None, 0),
    ],
    "recoverable_message_part": [
        (0, "chat_id", "INTEGER", 0, None, 1),
        (1, "message_id", "INTEGER", 0, None, 2),
        (2, "part_index", "INTEGER", 0, None, 3),
        (3, "delete_date", "INTEGER", 0, None, 0),
        (4, "part_text", "BLOB", 1, None, 0),
        (5, "ck_sync_state", "INTEGER", 0, "0", 0),
    ],
    "chat_handle_join": [
    ...
    "message_attachment_join": [
        (0, "message_id", "INTEGER", 0, None, 0),
        (1, "attachment_id", "INTEGER", 0, None, 0),
    ],
    "message": [
        (0, "ROWID", "INTEGER", 0, None, 1),
        (1, "guid", "TEXT", 1, None, 0),
        ...
        (80, "is_sos", "INTEGER", 0, "0", 0),
        (81, "is_critical", "INTEGER", 0, "0", 0),
        (82, "bia_reference_id", "TEXT", 0, None, 0),
        (83, "is_kt_verified", "INTEGER", 0, "0", 0),
        (84, "fallback_hash", "TEXT", 0, None, 0),
        (85, "associated_message_emoji", "TEXT", 0, None, 0),
    ...
    "attachment": [
        ...
        (4, "filename", "TEXT", 0, None, 0),
        (5, "uti", "TEXT", 0, None, 0),
        (6, "mime_type", "TEXT", 0, None, 0),
        (7, "transfer_state", "INTEGER", 0, "0", 0),
        (8, "is_outgoing", "INTEGER", 0, "0", 0),
        (9, "user_info", "BLOB", 0, None, 0),
        (10, "transfer_name", "TEXT", 0, None, 0),
        (11, "total_bytes", "INTEGER", 0, "0", 0),
        (12, "is_sticker", "INTEGER", 0, "0", 0),
        (13, "sticker_user_info", "BLOB", 0, None, 0),
        (14, "attribution_info", "BLOB", 0, None, 0),
        (15, "hide_attachment", "INTEGER", 0, "0", 0),
        (16, "ck_sync_state", "INTEGER", 0, "0", 0),
        (17, "ck_server_change_token_blob", "BLOB", 0, None, 0),
        (18, "ck_record_id", "TEXT", 0, None, 0),
        (19, "original_guid", "TEXT", 1, None, 0),
        (20, "is_commsafety_sensitive", "INTEGER", 0, "0", 0),
        (21, "emoji_image_content_identifier", "TEXT", 0, None, 0),
        (22, "emoji_image_short_description", "TEXT", 0, None, 0),
        (23, "preview_generation_state", "INTEGER", 0, "0", 0),
    ],
    "persistent_tasks": [
        (0, "ROWID", "INTEGER", 0, None, 1),
        (1, "guid", "TEXT", 1, None, 0),
        (2, "flag_group", "INTEGER", 1, None, 0),
        (3, "flag", "INTEGER", 1, None, 0),
        (4, "flag_priority", "INTEGER", 1, None, 0),
        (5, "lane", "INTEGER", 1, None, 0),
        (6, "reason", "INTEGER", 1, None, 0),
        (7, "reason_priority", "INTEGER", 1, None, 0),
        (8, "user_info", "BLOB", 0, None, 0),
        (9, "retry_count", "INTEGER", 0, "0", 0),
    ],
    "chat_lookup": [
        (0, "identifier", "TEXT", 1, None, 0),
        (1, "domain", "TEXT", 1, None, 0),
        (2, "chat", "INTEGER", 1, None, 0),
        (3, "priority", "INTEGER", 0, "0", 0),
    ],
    "sync_chat_slice": [
        (0, "service_name", "TEXT", 1, None, 0),
        (1, "ck_record_id", "TEXT", 0, None, 0),
        (2, "chat", "INTEGER", 1, None, 0),
    ],
    "chat_service": [
        (0, "service", "TEXT", 1, None, 0),
        (1, "chat", "INTEGER", 1, None, 0),
    ],
    "message_processing_task": [
        (0, "ROWID", "INTEGER", 0, None, 1),
        (1, "guid", "TEXT", 1, None, 0),
        (2, "task_flags", "INTEGER", 1, None, 0),
        (3, "reasons", "INTEGER", 1, None, 0),
    ],
    "sqlite_stat1": [
        (0, "tbl", "", 0, None, 0),
        (1, "idx", "", 0, None, 0),
